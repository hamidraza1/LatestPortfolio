  ...
  return (
    <Layout>
      ...
      <div className="md:w-3/5 md:pl-8">
        ...
        >
          Hi, my name is <span className="text-darkPurple">Hamid</span>
        </motion.h1>
        <motion.h1
          className="text-3xl font-bold text-mygray md:text-2xl lg:text-3xl"
          initial={{ marginLeft: "-20px", opacity: 0 }}
        ...
        >
          ...
          Development. I'm specialized in HTML/CSS, JavaScript, ReactJS, Gatsby
          on the frontend, but I'm pretty comfortable with Graphql, NodeJs and
          Firebase.
        </motion.p>
      </div>
